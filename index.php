...
<head>
<meta charset="utf-8">
<title>武汉的山科技有限公司 - Modern One Page Bootstrap Template</title>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				<h3 class="brand"><a href="index.php">武汉的山科技有限公司 </a></h3>
				<!-- navigation -->
				<nav class="pull-right nav-collapse collapse">
				<ul id="menu-main" class="nav">
					<li><a title="team" href="#about">我们</a></li>
					<li><a title="services" href="#services">服务</a></li>
					<li><a title="works" href="#works">业务</a></li>
					<li><a title="blog" href="#blog">博客</a></li>
					<li><a title="login" href="membershipSite/login.php">login</a></li>
...
<div id="header-wrapper" class="header-slider">
	...
	<div class="logo">
		<img src="img/rszlogo-image3.jpg" alt="" />
	</div>
	<div class="container">
		<div class="row">
			<div class="span12">
...
<div class="container">
	<div class="row">
		<div class="span6 offset3">
			...
			<p class="copyright">
				&copy; wuhandeshan. All rights reserved.
                <div class="credits">
                    <!-- 

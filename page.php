...
<head>
<meta charset="utf-8">
<title>武汉的山 - Modern One Page Bootstrap Template</title>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				<h1 class="brand"><a href="index.php">武汉的山</a></h1>
				<!-- navigation -->
				<nav class="pull-right nav-collapse collapse">
				<ul id="menu-main" class="nav">
					<li><a title="team" href="index.php#about">关于</a></li>
					<li><a title="services" href="index.php#services">服务</a></li>
					<li><a title="works" href="index.php#works">业务</a></li>
					<li><a title="blog" href="index.php#blog">博客</a></li>
					<li><a title="contact" href="index.php#contact">联系</a></li>
...
<div class="container">
	<div class="row">
		<div class="span6 offset3">
			...
			<p class="copyright">
				&copy; 2013 wuahandeshan Inc corporate. All rights reserved.
			</p>
		</div>
	</div>
</div>
